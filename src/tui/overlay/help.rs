...
const MANUAL: &[&str] = &[
    ...
    "  =              compare the cursored domain against the single marked domain,",
    "                 by relative DN — writes a .diff report (only-source/target/differing)",
    ...
    "                 (in the schema view: / filter, a/o add an attr/class — write mode;",
    "                  389-DS uses the admin bind, OpenLDAP needs config_bind_dn in the config)",
    "",
    "# Search  (/)",
    ...
    "  C              copy the selected user to the marked connection(s) — the focused",
    "                 domain is the source; mark writable targets with m in the rail.",
    "                 The DN is rebased onto each target's base-DN; dry-run targets preview.",
